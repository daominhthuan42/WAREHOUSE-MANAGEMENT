					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<!-- Xóa đi các menu không cần thiết 
						...
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img
									src="<c:url value="/resources/images/img.png"/>" alt="">Dao
									Minh Thuan
							</a>
							...
							<!-- Xóa đi những cái không cần thiết 
                    ...
                    <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                      <li class="nav-item">
                        <a class="dropdown-item">
                          <span class="image"><img src="<c:url value="/resources/images/img.png"/>" alt="Profile Image" /></span>
                          <span>
...
-->
			...
			<!-- footer content -->
			<footer>
				<div class="pull-right">WareHouse Management - copyright by
					Dao Minh Thuan</div>
				<div class="clearfix"></div>
			</footer>
			<!-- /footer content -->
